 ...
 * @internal
 *
 * @covers \Basilicom\Flysystem\Pdo\PdoAdapter
 */
final class PdoAdapterTest extends FilesystemAdapterTestCase
{
    ...
    protected static function createFilesystemAdapter(): FilesystemAdapter
    {
        ...
        return new \Basilicom\Flysystem\Pdo\PdoAdapter($pdo);
    }
